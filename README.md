...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/icontract-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15457&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/icontract-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `icontract` can be installed with:

```
conda install icontract
```

It is possible to list all of the versions of `icontract` available on your platform with:
